...
| REORG | Reorganización del repo: binario a `cmd/enu/` (ADR-030), archivo del spike, destilado del handoff, `plan`·`postponed` a un-fichero-por-entrada | [reorganizacion-repo.md](reorganizacion-repo.md) |
