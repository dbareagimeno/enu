...
> **codecs, re, fs, sys, log, text (width/truncate), http.request, http.stream, ws y
> search** del catálogo, más el **despacho de métodos-de-handle ⏸ validado**
> (desbloquea Proc/Ws/Stream). Faltan: text-Blocks (M13c) y proc (handle
> con métodos ⏸ — patrón ya validado). El patrón está
