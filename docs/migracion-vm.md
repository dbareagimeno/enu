...
> **▶ Próxima sesión: `M08`** (bus de eventos + input). Pendiente arrastrado a
> M09/integración: el **watchdog por época** (DM4, el presupuesto de slice vive
> en el Runtime). · Bitácora abajo.
