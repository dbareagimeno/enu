...
| ADR-028 | El release publica una imagen de contenedor multi-arch en GHCR como canal de ejecución para hosts sin binario nativo (complementa ADR-027) | Aceptada | [adr-028-imagen-de-contenedor-publicada.md](adr-028-imagen-de-contenedor-publicada.md) |
| ADR-029 | Recursos persistentes = lease reclamable por identidad verificable + reconciliación (doctrina de extensión; resuelve G60, consecuencia de ADR-025) | Aceptada | [adr-029-resiliencia-lease-reclamable-reconciliacion.md](adr-029-resiliencia-lease-reclamable-reconciliacion.md) |
| ADR-030 | El binario vive en `cmd/enu/`; la raíz del repo queda sin código Go (refina la ubicación de ADR-026) | Aceptada | [adr-030-el-binario-vive-en-cmd-enu.md](adr-030-el-binario-vive-en-cmd-enu.md) |
| ADR-031 | `plan/` y `postponed/` adoptan un fichero por entrada; `estado.md` se reduce a puntero + tablero (el registro por sesión vive en `worklog/`) | Aceptada | [adr-031-plan-y-postponed-un-fichero-por-entrada.md](adr-031-plan-y-postponed-un-fichero-por-entrada.md) |
