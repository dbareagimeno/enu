...
> **Estado: 46 registradas — 34 vigentes, 2 decididas ([P4](p04-package-manager-de-plugins.md)→ADR-025, [P21](p21-modelo-de-thinking-adaptativo.md)→ADR-016) y 10 implementadas (P22–P31).**
